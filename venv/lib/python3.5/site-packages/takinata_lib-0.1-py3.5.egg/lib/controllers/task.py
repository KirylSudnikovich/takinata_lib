...
class TaskController:
    ...
    @classmethod
    def add_task(cls, username, password, project_id, column_id, name, desc, type, start_date, start_time, end_date, end_time,
                 priority, parent_task_id = None, assosiated_task_id = None):
        """
        ...
        if user.password == password:
            ...
            if not have:
                task = Task(name=name,desc=desc,start_date=start_date, start_time=start_time, end_date=end_date,
                            end_time=end_time, priority=priority, type=type, period=period, is_archive=0, is_subtask=0, user_id=user.id,
                            category_id=column_id, project_id=project_id, parent_task_id=parent_task_id, assosiated_task_id=assosiated_task_id)
