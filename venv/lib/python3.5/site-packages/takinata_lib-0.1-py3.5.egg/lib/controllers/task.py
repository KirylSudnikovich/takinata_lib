...
from lib.storage.task_subtask import *
...
class TaskController:
    ...
    @classmethod
    def add_task(cls, username, password, project_id, column_id, name, desc, type, start_date, start_time, end_date,
                 end_time,
        ...
        if user.password == password:
            ...
            if not have:
                task = Task(name=name, desc=desc, start_date=start_date, start_time=start_time, end_date=end_date,
                            ...
                            user_id=user.id,
                            category_id=column_id, project_id=project_id, parent_task_id=parent_task_id,
        ...
        if task1.is_subtask == 0:
            if task1.start_date > task2.start_date and task1.end_date < task2.end_date:
                if task1.priority > task2.priority:
                    ...
                    task1.is_subtask = 1
                    task2.parent_task_id = 1
                    TaskSubtaskStorage.add_subtask(task1, task2)
