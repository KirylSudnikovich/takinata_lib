...
class ColumnController:
    ...
    @classmethod
    def edit_name_by_id(cls, username, password, project_id, column_id, new_name):
        """
        The change of name of the project
        :param username: username of column creator
        :param password: password of creator
        ...
        if person.password == password:
            project = ProjectStorage.get_project_by_id(project_id)
            ProjectStorage.is_admin(person, project)
            columns = ColumnController.show_all(username, password, project_id)
            have = False
            for col in columns:
    ...
    @classmethod
    def edit_desc_by_id(cls, username, password, project_id, column_id, new_desc):
        """
