...
class ColumnStorage:
    ...
    def save(self, category):
        ...
        :return:
        """
        new_category = ColumnStorage.session.query(Category).filter(Category.id == category.id).first()
    ...
    def get_all_columns(cls, project_id):
        ...
        columns = ColumnStorage.session.query(Category).filter(Category.project_id==project.id).all()
