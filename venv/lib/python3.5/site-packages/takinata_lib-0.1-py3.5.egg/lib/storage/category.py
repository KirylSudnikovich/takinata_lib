...
class CategoryStorage:
    ...
    def add_category_to_db(cls, category):
        ...
        for cat in all_categories:
            if cat.name == category.name and cat.project_id == category.project_id:
                have = True
        if not have:
    ...
    def get_column(cls, project_name, name):
        ...
        :return:
        """
        category = session.query(Category).filter(Category.name == name and Category.project_id == project.id).first()
        session.close()
        return category
    ...
    @classmethod
    def get_all_categories(cls, project_id):
        """
