"""A package that contains the logic for interacting with a database. The input receives data from the controller,
...
regular_task.py - the logic of interaction with the database for Regular Task
