"""A package that contains the logic of processing incoming data and the subsequent transfer of this data to the
...
regular_task.py - the file containing the logic of data processing and interaction with the database for Regular Task
